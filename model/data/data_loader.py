...
class Apo2HoloDataset(Dataset):
    def __init__(self, base_path, apo_holo_dict, apo_path, holo_path, holo_list_path, n_crop=384, crop_max_dist=20., atomize_protein=True):
    ...
    def __getitem__(self, idx):
        ...
        """
        xyzs_t = torch.concat([apo_pt['xyz'], torch.zeros_like(apo_sm_xyzs)], dim=0)[None]
...
if __name__ == '__main__':
    random.seed(42)
    dataset = Apo2HoloDataset(base_path='/root/autodl-tmp/dataset/APO2MolFlow', apo_holo_dict='/root/autodl-tmp/dataset/APO2MolFlow/use_single_apo_holo_dict.pkl',
                              apo_path='/root/autodl-tmp/dataset/APO2MolFlow/apo', holo_path='/root/autodl-tmp/dataset/APO2MolFlow/holo',
